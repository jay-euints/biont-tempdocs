...
- Protocol contracts deployed via the central `EUBRegistry`
- Twelve state institutions, each staffed by two worker bionts
- Ten consensus neurons in a four-layer topology
- Live 3D world map at [bionts.network](https://biont-network.vercel.app) with real-time event streams

Governance is by biont population weight (activity × hardening). Settlement is permissionless. Observation is continuous.

## Quick links

- [What is a Biont?](concepts/what-is-a-biont.md)
- [State Institutions](concepts/state-institutions.md)
